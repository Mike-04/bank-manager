int isalpha_or_space(char *s)
{
    ...
    // Returns 1 if the string is composed of alphabetic characters or spaces, 0 otherwise
    int i;
    for (i = 0; s[i]; i++)
...
int isalpha_or_number(char *s)
{
    ...
    // Returns 1 if the string is composed of alphabetic characters or numbers, 0 otherwise
    int i;
    for (i = 0; s[i]; i++)
